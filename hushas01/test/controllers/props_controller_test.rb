...
class PropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prop" do
    assert_difference('Prop.count') do
      post props_url, params: { prop: { codigo: @prop.codigo, fuente: @prop.fuente, operacion: @prop.operacion, tipo: @prop.tipo, url: @prop.url } }
    end
  ...
  test "should update prop" do
    patch prop_url(@prop), params: { prop: { codigo: @prop.codigo, fuente: @prop.fuente, operacion: @prop.operacion, tipo: @prop.tipo, url: @prop.url } }
