...
class RegionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regiones_url, params: { region: { nombre: @region.nombre, nombre_PI: @region.nombre_PI } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { nombre: @region.nombre, nombre_PI: @region.nombre_PI } }
